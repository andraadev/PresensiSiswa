...
- **Replaced Hard Delete Actions with Status-Based Records:**
    ...
    - Admin can change Student status to _Graduated (Lulus)_, _Transferred (Mutasi)_, or _Dropped Out (Keluar/DO)_.
...
[1.2.0]: https://github.com/andraadev/PresensiSiswa/releases/tag/1.2.0
